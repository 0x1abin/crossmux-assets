...
Definition data is published uncompressed. This costs more download and SD-card
space, but avoids the 32 KiB contiguous inflate allocation required by dictzip
lookups on memory-constrained devices.
